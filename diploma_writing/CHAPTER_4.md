...
Данный результат стал лучшим среди всех протестированных архитектур. Эффективность обогащенного бустинга подтверждает гипотезу о том, что вязкость жидкости кодируется в конкретных физических параметрах — частоте волн и скорости их распространения.
